...
module.exports = class FirehoseWriter {
  ...
  */
  constructor(options = {}) {
    ...
    validateParam(
      'maxSize',
      this.maxSize <= AWS_MAX_BATCH_SIZE,
      `should be at most ${AWS_MAX_BATCH_SIZE}`
    )

    this.maxCount = options.maxCount || 500
    validateParam(
      'maxCount',
      this.maxCount <= AWS_MAX_BATCH_RECORDS,
      `should be at most ${AWS_MAX_BATCH_RECORDS}`
    )
    ...
    validateParam(
      'maxBatchCount',
      this.maxBatchCount <= AWS_MAX_BATCH_RECORDS,
      `should be at most ${AWS_MAX_BATCH_RECORDS}`
    )
    ...
    validateParam(
      'maxBatchSize',
      this.maxBatchSize <= AWS_MAX_BATCH_SIZE,
      `should be at most ${AWS_MAX_BATCH_SIZE}`
    )
